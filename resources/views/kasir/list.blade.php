                ...
                <form method="POST" action="/kasir/store" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name_kasir" placeholder="Nama Kasir...."
                                required>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="/kasir/update/{{ $d->id }}">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label>Nama Kasir</label>
                                <input type="text" class="form-control" name="name" value="{{ $d->name_kasir }}"
                                    placeholder="Nama...." required>
                            </div>

                            <div class="form-group">
                                <label>No.telp</label>
                                <input type="text" class="form-control" name="no_telp" value="{{ $d->no_telepon }}"
